  ...
  static void init() {
    comics = [
      ComicModel(
        ...
        category: ['Fantasy', 'Comedy', 'Kids', 'Shounen', 'Slice of Life'],
        description:
      ...
      ComicModel(
        ...
        title: 'One Piece',
        author: 'Eiichiro Oda',
        category: ['Action', 'Adventure', 'Comedy', 'Shounen', 'Fantasy'],
        description:
      ...
      ComicModel(
        ...
        author: 'Aoyama Gosho',
        category: ['Adventure', 'Mystery', 'Shounen', 'Detective'],
        description:
    ...
    // nhân bản dữ liệu để tạo thêm số lượng
    for (var i = 0; i < 4; i++) {
      comics.addAll(List<ComicModel>.from(comics));
    }
  }
}
